...
def main():
    ...
    for line in open("input.PRO-PRO"):
        fragment = line.strip('\n')
    ...
    #os.system('../package/bin/dp_test -m ../package/model/PRO-PRO.pb -s . -S set -n ' + str(i) + ' -d detail')
    os.system('dp test -m ../package/model/PRO-PRO.pb -s . -S set -n ' + str(i) + ' -d detail')
