...
def main():
    ...
    for line in open("input.PRO-GLY"):
        fragment = line.strip('\n')
    ...
    os.system('dp test -m ../package/model/PRO-GLY.pb -s . -S set -n ' + str(i) + ' -d detail')
    #os.system('../package/bin/dp_test -m ../package/model/PRO-GLY.pb -s . -S set -n ' + str(i) + ' -d detail')
