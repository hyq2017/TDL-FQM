...
def main():
    ...
    for line in open("input.GLY-PRO"):
        fragment = line.strip('\n')
    ...
    #os.system('../package/bin/dp_test -m ../package/model/GLY-PRO.pb -s . -S set -n ' + str(i) + ' -d detail')
    os.system('dp test -m ../package/model/GLY-PRO.pb -s . -S set -n ' + str(i) + ' -d detail')
